...
function Base.event:extensionUnload(ext)
  if ext == vRP.EXT.GUI then
    vRP.EXT.GUI:removeMenuBuilder("main", "characters")
  elseif ext == vRP.EXT.Group then
    -- unregister fperm inside
    vRP.EXT.Group:unregisterPermissionFunction("inside")
  end
end
